<template>
  ...
  >
    <div class="flex flex-col w-full items-center">
      ...
      <span
        class="truncate block w-full px-4 py-2 border border-dashed rounded-md cursor-pointer transition-colors duration-300 h-16 bg-gray-100 hover:bg-gray-200 dark:bg-gray-900 dark:border-gray-600 dark:text-gray-200"
      ...
      <div v-if="isUploading" class="w-full bg-gray-300 dark:bg-gray-600 rounded-full h-2.5 mt-3">
        <div
          ...
          class="bg-emerald-500 dark:bg-emerald-400 h-2.5 rounded-full transition-all duration-300"
        ></div>
      </div>
